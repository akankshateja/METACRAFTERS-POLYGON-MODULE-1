...
const ABI = require('../artifacts/contracts/Wayfarer.sol/Wayfarer.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("Wayfarer");
  const nft = await NFT.attach('0x1CA77d77319a273700Dfe20dF41b62c88fCd7e99');
